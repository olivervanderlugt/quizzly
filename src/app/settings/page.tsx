    ...
    <div className="min-h-dvh bg-ink-50">
      <header className="border-b border-ink-200">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-5 py-4">
          ...
          <span className="text-sm text-ink-600">Settings</span>
        </div>
      </header>

      <main id="main" className="mx-auto max-w-2xl space-y-6 px-5 py-8">
        <section className="app-card p-5">
          <h1 className="font-semibold text-ink-900">Account</h1>
          <dl className="mt-3 space-y-2 text-sm">
            <div className="flex justify-between">
              <dt className="text-ink-600">Name</dt>
              <dd className="text-ink-700">{user.displayName}</dd>
            </div>
            <div className="flex justify-between">
        ...
        <section className="app-card p-5">
          <h2 className="font-semibold text-ink-900">AI generation key</h2>
        ...
        <section className="app-card border-red-200 p-5">
          <h2 className="font-semibold text-ink-900">Delete account</h2>
          <p className="mt-1 text-sm leading-relaxed text-ink-600">
          ...
          <form action={deleteAccountAction} className="mt-4">
            <label className="app-label" htmlFor="confirmEmail">
              Type <span className="font-mono text-ink-700">{user.email}</span> to
              confirm
            </label>
            <input
              id="confirmEmail"
